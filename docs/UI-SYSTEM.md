...
- Staff edit sheet form-first kalır; duplicate read-only üst özet veya ek müşteri/tarih/saat summary kartı taşımaz. Appointment ve walk-in aynı form omurgasını reuse eder; inputlar doğrudan görünür kalır.
