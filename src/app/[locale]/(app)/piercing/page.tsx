    ...
    <div className="app-section no-overflow-x pb-[calc(env(safe-area-inset-bottom)+96px)] sm:pb-0">
      ...
      <header className="space-y-4">
        <div className="relative aspect-[16/9] overflow-hidden rounded-2xl border border-border">
          ...
          <div className="absolute inset-x-0 bottom-0 p-3 text-[color:var(--on-image-foreground)]">
            ...
            <p className="line-clamp-1 text-sm text-[color:var(--on-image-muted)] drop-shadow-[0_1px_4px_rgba(0,0,0,0.5)]">
              {shortDescription}
            </p>
          </div>
        </div>
